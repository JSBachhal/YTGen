...
@Component({
  selector: 'app-aman-vid',
  templateUrl: './aman-vid.component.html',
  styleUrls: ['./aman-vid.component.scss']
})
export class AmanVidComponent extends EditorHelper implements AfterViewInit {
  ...
  getMdeiaStreeam() {
    ...
    mediaRecorder.onstop = (e) => {
      ...
      a.href = url;
      a.download = 'Find the odd one out.mp4';
      a.click();
  ...
  async renderImage(index: number = 0) {
    ...
    await this.addRapidText(0,[this.textOnTop],false, this.getCanvas().width/2, 160,
    {
      ...
      await this.addRapidText(0,[this.textOnBottom],false, this.getCanvas().width/2, this.canvasHeight+20,
    {
      color:'#f34573',
      strokeColor:"#FFF",
      drawOnBackround:false,
      backroundColor:'#f34573'})
